...
func encodeListOrderResponse(response ListOrderRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *ListOrderOKApplicationJSON:
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(200)
		span.SetStatus(codes.Ok, http.StatusText(200))
...
func encodeReadOrderResponse(response ReadOrderRes, w http.ResponseWriter, span trace.Span) error {
	switch response := response.(type) {
	case *OrderRead:
		w.Header().Set("Content-Type", "application/json")
		w.WriteHeader(200)
